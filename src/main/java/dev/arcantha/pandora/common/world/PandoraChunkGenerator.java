...
public class PandoraChunkGenerator implements IChunkGenerator {
    ...
    public PandoraChunkGenerator(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions)
    {
        {
