...
public abstract class RenderLivingBaseEx<T extends EntityLivingBase> extends RenderLivingBase {
    private static Logger LOGGER = LogManager.getLogger();

    public RenderLivingBaseEx(RenderManager renderManagerIn, ModelBase modelBaseIn, float shadowSizeIn) {
        super(renderManagerIn, modelBaseIn, shadowSizeIn);
        ModelRealPlayer modelRealPlayer = new ModelRealPlayer();
        this.mainModel = modelRealPlayer;
    }
    @Override
    public ModelBase getMainModel() {
        return new ModelRealPlayer();
    }
